use crate::resources::registers::camera::CameraRegistry;
use crate::resources::registers::mesh::MeshRegistry;
use crate::resources::registers::pipeline::PipelineRegistry;
use crate::resources::registers::texture::TextureRegistry;

use crate::resources::data::mesh::MeshData;
use crate::resources::data::texture::TextureData;
use crate::resources::desc::pipeline::PipelineDesc;
use crate::scene::camera::Camera;

use crate::types::id::{GlobalCameraId, GlobalMeshId, GlobalPipelineId, GlobalTextureId};
