...
fn vs_main(
    ...
    // Convert 2D position to vec4 and apply camera view-projection
    let pos4: vec4<f32> = vec4<f32>(model.position.x, model.position.y, 0.0, 1.0);
    out.clip_position = camera.view_proj * pos4;
